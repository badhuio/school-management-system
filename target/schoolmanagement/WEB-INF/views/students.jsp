...
<div class="wrapper">
    ...
    <div class="Inputs">
	 	...
	 	<h1>Admission Number <input type="text" id="AdmissionNumber"></h1>
	    <h1>Name <input type="text" id="Name"></h1>
		<h1>Class <input type="text" id="StudentClass"></h1>
		<h1>Section <input type="text" id="Section"></h1>
	    <h1>Gender <input type="text" id="Gender"></h1>
		<h1>DOB <input type="date" id="Dob"></h1>
		<h1>Parent Name	<input type="text" id="ParentName"></h1>
	    <h1>Mobile <input type="text" id="Mobile"></h1>
		<h1>Address <input type="text" id="Address"></h1>
		<h1>Admission Year <input type="text" id="AdmissionYear"></h1>
	    <h1>Status <input type="checkbox" id="Status"></h1>
